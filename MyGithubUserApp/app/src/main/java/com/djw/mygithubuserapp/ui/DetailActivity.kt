...
class DetailActivity : AppCompatActivity() {
    ...
    private fun setData(user: User) {
        binding.apply {
            ...
            if (user.isFavorite) {
                btnFavorite.setImageDrawable(ContextCompat.getDrawable(btnFavorite.context, R.drawable.ic_favorite_24))
            } else {
                btnFavorite.setImageDrawable(ContextCompat.getDrawable(btnFavorite.context, R.drawable.ic_favorite_out_24))
            }
        }
        Glide.with(this)
